...
exports.createConversation =  catchAsync(async (req,res,next)=>{
  ...
  exports.getConversationsForUser = catchAsync(async (req,res,next)=>{
    ...
    const offset = parseInt(req.query.offset) || 0; // Extract offset from query parameter (default to 0)
    ...
    .populate({
      ...
      options: {
        sort: { createdAt: -1 },
        skip: offset * limit, // Skip previously loaded messages based on pagination
        limit: limit  // Load the next set and additional latest 2 messages
      },
